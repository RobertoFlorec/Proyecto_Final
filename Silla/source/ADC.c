...
//Selecciona el tama�o de las muestras de promedio durante la conversion
void ADC_sampleSize(ADC_ChannelType channel, ADC_SampleSizes sampleSize)
{
	switch(channel)
		{
		case ADC_0:
			//seleciona el tama�o de muestras a elegir que exige 32
...
/**AQU� LA FUNCI�N DE LECTURA DEVUELVE UN ENTERO DE PRECISI�N-32 BITS DE LA LECTURA DEL ADC*/
